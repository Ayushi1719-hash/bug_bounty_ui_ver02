...
@Component({
  selector: 'app-bug-details-company',
  imports: [
    CommonModule,
    PdfViewerModule,
  ...
  templateUrl: './bug-details-company.component.html',
  styleUrl: './bug-details-company.component.scss',
  standalone: true,
})
export class BugDetailsCompanyComponent implements OnInit {
  bug: Bug | null = null;
  ...
  getStatusColor(status: string): string {
    console.log("getStatusColor called");
